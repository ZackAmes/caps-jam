    ...
    while i < turn.len() {
        ...
        match action.action_type {
            ...
            ActionType::Attack(target) => {
                ...
                assert!(attack_cost <= energy, "Not enough energy, attack cost: {}, energy: {}", attack_cost, energy);
                energy -= attack_cost;
            ...
            ActionType::Ability(target) => {
                ...
                assert!(ability_cost <= energy, "Not enough energy, ability cost: {}, energy: {}", ability_cost, energy);
                energy -= ability_cost;
