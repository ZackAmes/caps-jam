...
pub trait ISetInterface<T> {
    ...
    fn activate_ability(ref self: T, cap: Cap, target: Vec2, game: Game, locations: Felt252Dict<Nullable<Cap>>, keys: Felt252Dict<Nullable<Cap>>) -> (Game, Array<Effect>, Felt252Dict<Nullable<Cap>>);
}