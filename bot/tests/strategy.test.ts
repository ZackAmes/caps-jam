...
import type { PositionV6 } from '../src/game/v6';
...
function position(caps: ChainCap[], slot = 0): PositionV6 {
...
const run = (p: PositionV6) => previewTurn(p.game, p.hand, p.definitions, p.layout, greedyStrategy.chooseTurn(p));
